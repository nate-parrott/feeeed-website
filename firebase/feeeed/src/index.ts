...
exports.n0 = onSchedule({schedule: '0 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(0, N_SHARDS));
exports.n1 = onSchedule({schedule: '3 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(1, N_SHARDS));
exports.n2 = onSchedule({schedule: '6 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(2, N_SHARDS));
exports.n3 = onSchedule({schedule: '9 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(3, N_SHARDS));
exports.n4 = onSchedule({schedule: '12 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(4, N_SHARDS));
exports.n5 = onSchedule({schedule: '15 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(5, N_SHARDS));
exports.n6 = onSchedule({schedule: '18 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(6, N_SHARDS));
exports.n7 = onSchedule({schedule: '21 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(7, N_SHARDS));
exports.n8 = onSchedule({schedule: '24 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(8, N_SHARDS));
exports.n9 = onSchedule({schedule: '27 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(9, N_SHARDS));
exports.n10 = onSchedule({schedule: '30 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(10, N_SHARDS));
exports.n11 = onSchedule({schedule: '33 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(11, N_SHARDS));
exports.n12 = onSchedule({schedule: '36 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(12, N_SHARDS));
exports.n13 = onSchedule({schedule: '39 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(13, N_SHARDS));
exports.n14 = onSchedule({schedule: '42 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(14, N_SHARDS));
exports.n15 = onSchedule({schedule: '45 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(15, N_SHARDS));
exports.n16 = onSchedule({schedule: '48 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(16, N_SHARDS));
exports.n17 = onSchedule({schedule: '51 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(17, N_SHARDS));
exports.n18 = onSchedule({schedule: '54 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(18, N_SHARDS));
exports.n19 = onSchedule({schedule: '57 * * * *', timeoutSeconds: TIMEOUT}, async (ctx) => await notify(19, N_SHARDS));
